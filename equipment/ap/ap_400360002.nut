...
{
	appendage.sq_AddFunctionName("onStart", "onStart_appendage_400360002")
	appendage.sq_AddFunctionName("onEnd", "onEnd_appendage_400360002")
}

function onStart_appendage_400360002(appendage)
{
	if (!appendage) return;
	...
	local change_appendage = appendage.sq_getChangeStatus("400360002");
	
	if (!change_appendage)
	{
		change_appendage = appendage.sq_AddChangeStatus("400360002", obj, obj, 0, CHANGE_STATUS_TYPE_PHYSICAL_ATTACK, false, physicalAttack);
	}
	if (change_appendage)
	{
...
function onEnd_appendage_400360002(appendage)
{
	if (!appendage) return;
