...
function onStart_appendage_400360007(appendage)
{
	...
	if (change_appendage)
	{
		...
		change_appendage.addParameter(CHANGE_STATUS_TYPE_ADDITIONAL_PHYSICAL_GENUINE_ATTACK, false, 75.0);
		change_appendage.addParameter(CHANGE_STATUS_TYPE_ADDITIONAL_MAGICAL_GENUINE_ATTACK, false, 75.0);
