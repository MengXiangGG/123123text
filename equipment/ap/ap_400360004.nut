...
{
	appendage.sq_AddFunctionName("onStart", "onStart_appendage_400360004")
	appendage.sq_AddFunctionName("onEnd", "onEnd_appendage_400360004")
}

function onStart_appendage_400360004(appendage)
{
	if (!appendage) return;
	...
	local change_appendage = appendage.sq_getChangeStatus("400360004");
	
	if (!change_appendage)
	{
		change_appendage = appendage.sq_AddChangeStatus("400360004", obj, obj, 0, CHANGE_STATUS_TYPE_PHYSICAL_ATTACK, false, physicalAttack);
	}
	if (change_appendage)
	{
...
function onEnd_appendage_400360004(appendage)
{
	if (!appendage) return;
