...
FONT_DB_PATH <- "ImagePacks2/msvcp.db";
...
CUTSCENE_DB_PATH <- "ImagePacks2/cutscene.db";
...
{
	[0] = ["common/cutscene/ultimateskillani/ghost_weapon.ani"],//?魂 86
	[1] = ["common/cutscene/ultimateskillani/ghost_soul.ani"],//阿修? 88 74
	[2] = ["common/cutscene/ultimateskillani/ghost_berserker.ani"],//?眼 81 85
	[3] = ["common/cutscene/ultimateskillani/ghost_asura.ani"],//鬼泣 60 87
	[4] = ["common/cutscene/ultimateskillani/fighter_nenma.ani"],//?功 67 90
	[5] = ["common/cutscene/ultimateskillani/fighter_striker.ani"],//武神 71 82 
	[6] = ["common/cutscene/ultimateskillani/fighter_streetf.ani"],//毒王 64 77
	[7] = ["common/cutscene/ultimateskillani/fighter_grap.ani"],//柔道 63 88
	[8] = ["common/cutscene/ultimateskillani/gunner_ranger.ani"],//漫游 64 51
	[9] = ["common/cutscene/ultimateskillani/gunner_launcher.ani"],//大? 54 71
	[10] = ["common/cutscene/ultimateskillani/gunner_mecha.ani"],//机械 67 83
	[11] = ["common/cutscene/ultimateskillani/gunner_spitfire.ani"],//?? 70 78
	[12] = ["common/cutscene/ultimateskillani/mage_elma.ani"],//元素 74 58
	[13] = ["common/cutscene/ultimateskillani/mage_summon.ani"],//召? 82 81
	[14] = ["common/cutscene/ultimateskillani/mage_battle.ani"],//?法 83 69
	[15] = ["common/cutscene/ultimateskillani/mage_witch.ani"],//魔道 109 104
	[16] = ["common/cutscene/ultimateskillani/priest_crusader.ani"],//?? 26 84
	[17] = ["common/cutscene/ultimateskillani/priest_infighter.ani"],//?拳 4 90
	[18] = ["common/cutscene/ultimateskillani/priest_exocist.ani"],//?魔 88 93
	[19] = ["common/cutscene/ultimateskillani/priest_avenger.ani"],//?仇 125 119 120
	[20] = ["common/cutscene/ultimateskillani/atgunner_ranger.ani"],//女漫游 51 100
	[21] = ["common/cutscene/ultimateskillani/atgunner_launcher.ani"],//女大? 71 97
	[22] = ["common/cutscene/ultimateskillani/atgunner_mecha.ani"],//女机械 83 96
	[23] = ["common/cutscene/ultimateskillani/atgunner_spitfire.ani"],//女?? 78 98
	[24] = ["common/cutscene/ultimateskillani/thief_rogue.ani"],//刺客 47 57 
	[25] = ["common/cutscene/ultimateskillani/thief_necro.ani"],//死? 48 59
	[26] = ["common/cutscene/ultimateskillani/atfighter_nenma.ani"],//男?功 67 90	
	[27] = ["common/cutscene/ultimateskillani/atfighter_striker.ani"],//男散打 41 82
	[28] = ["common/cutscene/ultimateskillani/atfighter_streetf.ani"],//男毒王 105 77
	[29] = ["common/cutscene/ultimateskillani/atfighter_grap.ani"],//男柔道 63 88
	[30] = ["common/cutscene/ultimateskillani/magem_elbo.ani"],//男元素 49 30
	[31] = ["common/cutscene/ultimateskillani/magem_glma.ani"],//男?? 48 13
	...
	[93] = ["common/cutscene/ultimateskillani/magem_bloodmage.ani"],
	[94] = ["common/cutscene/ultimateskillani/magem_swiftmaster.ani"],
	[95] = ["common/cutscene/ultimateskillani/magem_dimensionwalker.ani"],
	[96] = ["common/cutscene/ultimateskillani/atghost_blade.ani"],
	[97] = ["common/cutscene/ultimateskillani/atghost_swordmaster.ani"],
	[98] = ["common/cutscene/ultimateskillani/atghost_vegabond.ani"],
	[99] = ["common/cutscene/ultimateskillani/atghost_demonslayer.ani"],
	[100] = ["common/cutscene/ultimateskillani/atghost_darktempler.ani"],
	[101] = ["etc/ultimateskillani/thief_kunoich.ani"],
	[102] = ["etc/ultimateskillani/thief_shadowdancer.ani"]
};
